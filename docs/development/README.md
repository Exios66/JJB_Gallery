...
Development guides and technical documentation for working with the JJB Gallery repository.

## 📋 Available Guides

- **[Git Protocol Guide](./GIT_PROTOCOL_GUIDE.md)** - Git and GitHub setup, SSH configuration, and best practices
- **[Remote Python Paths](./REMOTE_PYTHON_PATHS.md)** - Configuration for remote Python environments
