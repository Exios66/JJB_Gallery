...
Each project may require environment variables. See [Configuration Guide](Configuration-Guide.md) for details.
...
1. **Configure Environment Variables** - See [Configuration Guide](Configuration-Guide.md)
