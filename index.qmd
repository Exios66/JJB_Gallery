...
**🎉 Recent Major Update (December 2024):** The repository has been comprehensively reorganized for better maintainability and clarity. All documentation, requirements, and configuration files have been moved to organized subdirectories. See the [Repository Organization](#repository-organization) section for details.
...
- **Psychometrics (NASA TLX):** Complete implementation of NASA Task Load Index for workload assessment with statistical analysis ([View Project](projects/Psychometrics/README.md))
- **RAG Model Application:** Full RAG pipeline with vector database, embeddings, and document retrieval ([View Project](projects/RAG_Model/README.md))
- **Chat UI (SvelteKit):** Modern chat interface for LLM interactions with multiple backend support ([View Project](projects/ChatUi/README.md))
- **iOS Chatbot:** Flask-based chatbot with mobile-friendly interface ([View Project](projects/ios_chatbot/README.md))
- **LiteLLM Proxy:** Unified API proxy for multiple LLM providers ([View Project](projects/litellm/README.md))

### Enhanced Existing Projects
- **Random Forest Analysis:** Enhanced with interactive visualizations and decision boundary plots ([View Analysis](Quarto/randomforest.qmd))
...
**📋 Track all changes:** See [CHANGELOG.md](CHANGELOG.md) for detailed version history
...
- **Random Forest Essentials** – Quarto doc, 2024. ([Link](Quarto/randomforest.qmd))
...
- [Terminal Agents Project](projects/terminal_agents/README.md) - AI coding agents for terminal
- [CrewAI Multi-Agent System](projects/CrewAI/README.md) - Multi-agent orchestration
- [Psychometrics (NASA TLX)](projects/Psychometrics/README.md) - Workload assessment toolkit
- [RAG Model Application](projects/RAG_Model/README.md) - Retrieval-augmented generation
...
- [Repository Organization](docs/ORGANIZATION.md) - File organization guide
- [CHANGELOG.md](CHANGELOG.md) - Version history and changes
- [SECURITY.md](SECURITY.md) - Security policy

### External Resources
- [Official Python Template Repo](https://github.com/Exios66/python-template) - Best practices starter
